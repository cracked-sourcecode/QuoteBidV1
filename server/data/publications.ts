...
const publicationLogos = {
  ...
  globeStreet: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200'%3E%3Crect width='200' height='200' fill='%23fff'/%3E%3Ccircle cx='100' cy='100' r='90' fill='%23006837' stroke='%23004d26' stroke-width='4'/%3E%3Ctext x='100' y='90' text-anchor='middle' font-family='Arial,sans-serif' font-weight='bold' font-size='24' fill='%23fff'%3EGlobe%3C/text%3E%3Ctext x='100' y='115' text-anchor='middle' font-family='Arial,sans-serif' font-weight='bold' font-size='24' fill='%23fff'%3EStreet%3C/text%3E%3C/svg%3E"
};
