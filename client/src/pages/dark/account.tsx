  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div 
          className={`w-72 min-h-screen bg-slate-900/90 backdrop-blur-xl border-r border-slate-700/60 p-6 fixed overflow-y-auto transition-transform duration-300 ease-in-out z-40 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 hidden lg:block`} 
        ...
        >
          <div className="space-y-6">
            ...
            <div className="flex flex-col items-center text-center">
              <div 
                className="w-32 h-32 rounded-full bg-slate-800 mb-4 relative group cursor-pointer border-2 border-slate-600/50"
              ...
              >
                ...
                {isEditing && (
                  <div className="absolute inset-0 rounded-full bg-black/0 flex items-center justify-center transition-all duration-200 group-hover:bg-black/50">
        ...
        <div className="w-full lg:ml-72 transition-all duration-300 ease-in-out account-content-area bg-slate-900">
          <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            {/* Mobile Profile Header */}
            <div className="lg:hidden mb-6">
              <div className="flex items-center space-x-4 mb-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-slate-800 relative flex-shrink-0 border-2 border-slate-600/50">
                  {(user.avatar || avatarPreview) && (
                    <img 
                      src={avatarPreview || user.avatar || ''} 
                      alt={user.fullName || 'Profile'} 
                  ...
                  <div className="flex items-center justify-center w-full h-full rounded-full bg-slate-700 text-slate-300 font-bold text-xl sm:text-2xl fallback-avatar" style={{display: (user.avatar || avatarPreview) ? 'none' : 'flex'}}>
                    {user.fullName ? user.fullName.charAt(0).toUpperCase() : 'U'}
                  </div>
                </div>
                  ...
                  <>
                    ...
                    <div className="mb-6">
                     ...
                     <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                       <TabsList className="grid w-full grid-cols-3 mb-4 sm:mb-6 h-auto bg-slate-800 border border-slate-700">
                         <TabsTrigger value="info" className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 py-2 sm:py-3 text-xs sm:text-sm text-slate-400 data-[state=active]:bg-slate-700 data-[state=active]:text-slate-100">
                           <User className="h-4 w-4" />
                           <span className="hidden sm:inline">Profile</span>
                           <span className="sm:hidden">Info</span>
                         </TabsTrigger>
                         <TabsTrigger value="billing" className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 py-2 sm:py-3 text-xs sm:text-sm text-slate-400 data-[state=active]:bg-slate-700 data-[state=active]:text-slate-100">
                           <CreditCard className="h-4 w-4" />
                           <span>Billing</span>
                         </TabsTrigger>
                         <TabsTrigger value="email-preferences" className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 py-2 sm:py-3 text-xs sm:text-sm text-slate-400 data-[state=active]:bg-slate-700 data-[state=active]:text-slate-100">
