      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700/50 p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold text-white mb-2">My Pitches</h1>
              <p className="text-gray-300 text-sm">Track your submissions and view published articles</p>
            </div>
            <button 
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="bg-gradient-to-br from-amber-900/40 to-amber-800/30 rounded-xl p-3 border border-amber-700/50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-amber-300 mb-1">Drafts</p>
                  <p className="text-xl font-bold text-amber-100">{stats.drafts}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/30 rounded-xl p-3 border border-blue-700/50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-blue-300 mb-1">Submitted</p>
                  <p className="text-xl font-bold text-blue-100">{stats.submitted}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-green-900/40 to-green-800/30 rounded-xl p-3 border border-green-700/50">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-green-300 mb-1">Published</p>
                  <p className="text-xl font-bold text-green-100">{stats.published}</p>
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-slate-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-slate-700/50 text-white placeholder-gray-400 hover:bg-slate-700 transition-colors"
              />
            </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700/50 overflow-hidden">
          {allPitches.length === 0 ? (
            ...
            <div className="text-center py-10 px-6">
              ...
              <Button onClick={() => setSearchQuery("")} variant="outline" className="rounded-lg px-4 py-2 border-slate-600 bg-slate-800/50 text-gray-300 hover:bg-slate-700 hover:text-white backdrop-blur-sm">
                Clear Search
              </Button>
            </div>
          ) : (
            ...
            <div className="divide-y divide-slate-700/50">
              {paginatedPitches.map((pitch, index) => {
                ...
                return (
                  <div key={pitch.id} className={`p-4 hover:bg-slate-700/30 transition-all duration-200 ${index === 0 ? 'rounded-t-2xl' : ''} ${index === filteredPitches.length - 1 ? 'rounded-b-2xl' : ''}`}>
                    <div className="flex items-center justify-between">
                      {/* Left: Title and Publication */}
                      <div className="flex-1 min-w-0 mr-4">
                        <div className="flex items-center space-x-3 mb-2">
                          <h3 className="font-semibold text-white max-w-xl truncate">
                        ...
                        {pitch.isDraft ? (
                          ...
                          <>
                            {['pending'].includes(pitch.status) && (
                              <Button size="sm" variant="outline" onClick={() => handleEditPitch(pitch)} className="px-3 py-1.5 rounded-lg border-slate-600 bg-slate-800/50 text-gray-300 hover:bg-slate-700 hover:text-white hover:border-slate-500 text-xs backdrop-blur-sm">
                                <Edit className="h-3 w-3 mr-1" />
                                Edit
                              </Button>
                            )}
                            <Button size="sm" variant="outline" onClick={() => handleReviewPitch(pitch)} className="px-3 py-1.5 rounded-lg border-slate-600 bg-slate-800/50 text-gray-300 hover:bg-slate-700 hover:text-white hover:border-slate-500 text-xs backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      className="border-slate-600 bg-slate-800/50 text-gray-300 hover:bg-slate-700 hover:text-white disabled:opacity-50 disabled:cursor-not-allowed backdrop-blur-sm"
                    >
                        ...
                        <Button
                          ...
                          className={
                            currentPage === page
                              ...
                              : "border-slate-600 bg-slate-800/50 text-gray-300 hover:bg-slate-700 hover:text-white backdrop-blur-sm px-3 py-1.5"
                          }
                        >
                          {page}
                        </Button>
