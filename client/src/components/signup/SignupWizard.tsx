        ...
        <header className="relative z-30 py-4 px-4 md:py-6 md:px-8 flex-shrink-0">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center cursor-default">
              ...
              <div className="ml-2 md:ml-3 px-2 py-1 bg-blue-500/20 border border-blue-400/30 rounded text-blue-300 text-xs font-bold uppercase tracking-wider backdrop-blur-sm flex items-center">
                Beta
              </div>
            </div>
            
            {/* Center: Signup banner - Hide on mobile */}
            ...
            {/* Right: Space for balance - Hide on mobile */}
