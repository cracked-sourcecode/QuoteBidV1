              ...
              <React.Fragment key={stage.key}>
                ...
                <div className="flex flex-col items-center relative z-10">
                  ...
                  <div className={`
                    ...
                    ${isCompleted ? 'bg-blue-500 shadow-lg shadow-blue-500/25' :
                      ...
                      'bg-slate-800/10 border border-slate-700/30'
                    }
                  `}>
                    {isCompleted ? (
                      ...
                      <stage.icon className={`h-5 w-5 sm:h-6 sm:w-6 ${
                        isCurrent ? 'text-blue-500' : 'text-slate-600'
                      }`} />
                    )}
                ...
                {index < LINEAR_STAGES.length - 1 && (
                  <div className="flex-1 h-0.5 mx-4 relative">
                    <div className="absolute inset-0 bg-slate-700/20 rounded-full" />
                ...
                <div key={outcome.key} className="flex flex-col items-center relative z-10 flex-1">
                  ...
                  <div className={`
                    ...
                    ${isActive ? (
                      ...
                      'bg-slate-800/5 border border-slate-700/20'
                    ) : (
                      'bg-slate-800/10 border border-slate-700/30'
                    )}
                  `}>
